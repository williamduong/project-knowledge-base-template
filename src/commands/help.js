function runHelp({ packageJson, args }) {
  ...
  if (!showAdvanced) {
    ...
    console.log('  kb extract <source-file> [--target-doc=<path>] [--apply=<output>] [--uncovered] [--model=<hint>] [--yes] [--json]');
    console.log('  kb ingest <source-file> [--type=auto|text|pdf|image|docx|xlsx] [--json]');
