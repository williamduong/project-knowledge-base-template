...
3. Use [12-ai-skills/prompting-guide.md](12-ai-skills/prompting-guide.md) to pick the right prompt style.
4. Start the queue in [00-start-here/finalization-plan.md](00-start-here/finalization-plan.md).
5. Build or maintain the KB using prompts from [12-ai-skills/prompt-pack.md](12-ai-skills/prompt-pack.md).
6. When updating template versions later, use [12-ai-skills/version-patch-prompts.md](12-ai-skills/version-patch-prompts.md) with [TEMPLATE_CHANGELOG.md](TEMPLATE_CHANGELOG.md).
