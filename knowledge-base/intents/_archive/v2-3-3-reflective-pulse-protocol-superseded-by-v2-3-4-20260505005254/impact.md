...
- `template/.github/agents/kbx.agent.template.md` — add pulse trigger instructions at T1/T2/T3
...
Owned by v2.3.3. No version bump to chaos formula. No change to `kbx chaos` command.
