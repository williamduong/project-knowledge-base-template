...
- Downstream projection paths created by `kb init`
...
Downstream projection names remain `.github/agents/kb.agent.md` and `.github/prompts/kb-*.prompt.md` after `kb init`.
