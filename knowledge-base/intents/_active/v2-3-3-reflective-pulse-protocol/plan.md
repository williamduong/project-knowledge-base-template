...
Modify `template/.github/agents/kb.agent.template.md` to auto-invoke pulse at:
...
- Add explicit pulse invoke: either a new prompt file `kb-pulse.prompt.template.md` or a new subcommand `kb intent pulse [<intent-id>]`
