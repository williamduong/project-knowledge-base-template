...
- `template/.github/prompts/kb-ask.prompt.md` (version sync)
- `template/.github/prompts/kb-plan.prompt.md` (version sync)
- `template/.github/prompts/kb-run.prompt.md` (version sync)
